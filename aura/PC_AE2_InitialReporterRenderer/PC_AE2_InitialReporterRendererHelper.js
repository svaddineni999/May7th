({
    getInitialReportData : function(component, event, helper){
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                component.set("v.permissionToContactReporterOptions", returnValue.permissionToContactReporterOptions);
                component.set("v.preferredResponseChannelOptions", returnValue.preferredResponseChannelOptions);
                component.set("v.preferredResponseWindowOptions", returnValue.preferredResponseWindowOptions);
                ...
                if($A.util.isEmpty(aeId) && (!$A.util.isEmpty(caseId) || (!$A.util.isEmpty(patientId) ))){
                    ...
                    if(!$A.util.isEmpty(returnValue.defaultPatientReporter) && (!$A.util.isEmpty(returnValue.defaultReporterTypeValue))){
                        var reporterWrapper = returnValue.defaultPatientReporter
                         ...
                         aeWrapper['permissionToContactReporter'] = returnValue.defaultPermissionToContactReporter;
                         aeWrapper['preferredResponseChannel'] = returnValue.defaultPreferredResponseChannel;
                         aeWrapper['preferredResponseWindow'] = returnValue.defaultPreferredResponseWindow;
                      ...
                      // component.set("v.showRefreshIcon" , true);
                        helper.cloneExisitngMap(component ,reporterWrapper);
            ...
            if (state == "SUCCESS"){
                ...
                if(!$A.util.isEmpty(aeWrap)){
                   ...
                   component.set("v.showRefreshIcon" ,true);
                    ...
                    helper.cloneExisitngMap(component,aeWrap);
                        //component.set("v.existingReporterMap",aeWrap );
                    if($A.util.isEmpty(reporterType)){
    ...
    resetReporterValues: function(component, event, helper){
        ...
        aeWrapper['email'] = '';
        aeWrapper['fax'] = '';
        aeWrapper['permissionToContactReporter'] = 'Yes';
        aeWrapper['preferredResponseChannel'] = '';
        aeWrapper['preferredResponseWindow'] = '';
    ...
    setAE2Wrapper: function(component,aeWrapper ,reporterWrapper){
        ...
        aeWrapper['fax']=reporterWrapper.fax;
        aeWrapper['preferredResponseChannel']=reporterWrapper.preferredResponseChannel;
        component.set("v.aeWrapper",aeWrapper);
        console.log('reporterWrapper'+reporterWrapper);
    },


    cloneExisitngMap: function(component , aeWrapper){
        ...
        if(!$A.util.isEmpty(aeWrapper.fax)){
            existingMap['fax']=aeWrapper.fax;
        }
        if(!$A.util.isEmpty(aeWrapper.permissionToContactReporter)){
            existingMap['permissionToContactReporter']=aeWrapper.permissionToContactReporter;
        }
        if(!$A.util.isEmpty(aeWrapper.preferredResponseChannel)){
            existingMap['preferredResponseChannel']=aeWrapper.preferredResponseChannel;
        }
        if(!$A.util.isEmpty(aeWrapper.preferredResponseWindow)){
            existingMap['preferredResponseWindow']=aeWrapper.preferredResponseWindow;
        }
