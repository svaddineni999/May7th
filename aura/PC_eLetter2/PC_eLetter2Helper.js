/**
 * Created by satheesh kumar on 6/29/2020.
 */
({
            ...
            if (state === 'SUCCESS'){
                ...
                if(renderedMailTemplate !== undefined){
                    ...
                    if(renderedMailTemplate.templateAttachments != undefined && renderedMailTemplate.templateAttachments.length > 0){
                        console.log('renderedMailTemplate.templateAttachments-->'+renderedMailTemplate.templateAttachments);
    ...
    */
    sendEletter: function(component, event, helper){
        ...
        //selectedRecipients = selectedRecipients.concat(component.get("v.additionalEmailRecipientList"));
    ...
    */
    ...
    showSuccessToast : function(component, event, helper){
        /*var successMessage = component.get("v.toastSendSuccessMessage");
        if(component.get('v.closeTabAfterSend')){
             successMessage = successMessage+ ' '+ component.get("v.pageCloseMessage");
        }*/
