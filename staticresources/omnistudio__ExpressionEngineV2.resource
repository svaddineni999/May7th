  ...
  */
  ...
  const EXPRESSIONS = {
      ...
      CONCATENATE: function(...args) {
          // If called as CONCATENATE([1,2]) instead of CONCATENATE(1,2)
          // flatten to array if single arg is an array-like
      ...
      SUM: function(array) {
          var result = EXPRESSIONS.ARRAY(arguments).reduce(function(currentVal, next) {
              /* jshint eqnull:true */
              if (next == null) {
                  next = 0;
              }
          ...
          // W-15825641 : precision error when calculating floating numbers
          return result !== Math.floor(result)? parseFloat(result.toFixed(2)) : result;
      },
      ...
      AGE: function(birth_date) {
          ...
          return EXPRESSIONS.AGEON(birth_date, now);
      },
